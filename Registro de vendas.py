print("====REGISTRO DEVENDAS====")
print("Digite o valor de cada venda.")
print("Para encerrar, digite 'fim'.\n")
total_vendas=0
quantidade_vendas=0
entrada=input("Digite o valor da venda: ")
...
print("\nRegistro encerrado. Obrigado por utilizar o sistema!")